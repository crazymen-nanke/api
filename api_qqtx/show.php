...
<div style="box-shadow: 5px 5px 25px 0 rgba(46,61,73,.2);border-radius:15px;font-size:13px;width:950px;font-family:微软雅黑,'Helvetica Neue',Arial,sans-serif;margin:10px auto 0px;border:0px solid #eee;max-width:100%;">
    ...
    <div style="margin:0px auto;width:90%">
		...
		<hr>
		# 请求地址 #<br/>
		<a style="color:#fd4b5c;text-decoration:none;">https://api.crazymen.cn/api_qqtx/</a><br/>
		# 参数 #<br/>
		<li>qq //要查询的QQ号(必填)</li> 
		<hr>
		# 返回数据 #<br/>
		...
		{"code":1,"imgurl":"https://q.qlogo.cn/headimg_dl?dst_uin=2395353168&spec=100","name":"白情长柯"}<br/>
        {"code":-1,"msg":"Error"}<br/>
		</div>
		<hr>
		# 备注 #<br/>
		...
		<hr>
		# 示例 #<br/>
		<a style="color:#fd4b5c;text-decoration:none；" target="_blank">https://api.crazymen.cn/api_qqtx/?qq=2395353168</a>
		</h3>
          </div>
</div>
</html>