...
<div style="box-shadow: 5px 5px 25px 0 rgba(46,61,73,.2);border-radius:15px;font-size:13px;width:950px;font-family:微软雅黑,'Helvetica Neue',Arial,sans-serif;margin:10px auto 0px;border:0px solid #eee;max-width:100%;">
    ...
    <div style="margin:0px auto;width:90%">
		...
		<hr>
		# 请求地址 #<br/>
		<a style="color:#fd4b5c;text-decoration:none;">https://api.crazymen.cn/api_yan/</a><br/>
		# 参数 #<br/>
		...
		<hr>
		# 备注 #<br/>
		js调用举例:&lt;script src="http://api.btstu.cn/yan/api.php?encode=js">&lt;/script><br/>
        js输出举例:&lt;div>&lt;script>binduyan()&lt;/script>&lt;/div>
		<hr>
		# 示例 #<br/>
		<a style="color:#fd4b5c;text-decoration:none；" target="_blank">https://api.crazymen.cn/api_yan/?charset=utf-8</a><br>
        <a style="color:#fd4b5c;text-decoration:none；" target="_blank">https://api.crazymen.cn/api_yan/?encode=js</a>
		</h3>
          </div>
</div>
</html>
